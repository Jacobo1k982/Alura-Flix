          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <Grid rowSpacing={5} container sx={{
              ...
              <Grid item xs={12}  >
                ...
                <Typography align='center' variant='h6' color="#ffffff"> Complete el formulario para crear una nueva tarjeta de video</Typography>
              ...
              <Grid item xs={12}>
                <FormControl fullWidth>
                  <InputLabel id="demo-simple-select-helper-label">Seleccione una categoría</InputLabel>
                  <Controller
                    name="Categoria"
                    control={control}
                    defaultValue=""
                  ...
                  render={({ field }) => (
                    <div>
                      <TextField
                        ...
                        variant="filled"
                        fullWidth
                        label="¿De qué se trata este vídeo?"
                        id="descripcion"
                        multiline rows={5}
                      />
                      {errors.descripcion && (
